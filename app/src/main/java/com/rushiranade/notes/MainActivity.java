    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                EditText editTextHeading = (EditText) findViewById(R.id.titleField);
                ...
                if (!heading.isEmpty()) {
                    if (!content.isEmpty()) {
                        ...
                        editTextContent.setError("El contenido no puede estar vacío!");
                    }
                } else {
                    editTextHeading.setError("El título no puede estar vacío!");
                }
